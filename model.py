...
class BiLSTM(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        ...
        self.fc = nn.Linear(hidden_dim * 2, output_dim)  # Multiply by 2 to account for both forward and backward LSTM
    ...
    def forward(self, x):
        ...
        bilstm_out = torch.cat((bilstm_out[:, :, :self.hidden_dim], bilstm_out[:, :, self.hidden_dim:]), dim=2)
